    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-blue-50 via-white to-blue-100 flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-5xl">
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="mt-6 flex items-center justify-between">
                  <span className="text-gray-700 font-semibold">Continue</span>
        ...
        <div className="mt-6 text-center text-xs text-gray-500">
          Use your browser back button or open this page again anytime to pick a
          different college.
        </div>
      </div>
    </div>
